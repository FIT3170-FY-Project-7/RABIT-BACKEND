...
export const INSERT_PLOT_CONFIG = `INSERT INTO plot_config VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);`;
...
export const INSERT_DATASET_SIGMA = `INSERT INTO dataset_sigmas VALUES (?, ?);`;

export const INSERT_DATASET_QUANTILE = `INSERT INTO dataset_quantiles VALUES (?, ?);`;
